...
echo "<td colspan=5><input name=nombre></input></td>";
echo "<td colspan=5><input name=ip></input></td>";
echo "<td colspan=5><input name=usuariomysql></input></td>";
echo "<td colspan=5><input name=passwordmysql></input></td>";
echo "</tr>";
echo "<tr align=center class=tablatitulo>";
